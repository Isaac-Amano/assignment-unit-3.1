...
let favoriteFoodsArray = ['tacos', 'pizza', 'subs'];
...
favoriteFoodsArray.push(dessert);
...
let entree = 'steak';
favoriteFoodsArray.unshift(entree);
console.log('Added an entree to beginning: ', favoriteFoodsArray);
...
let gemColors = ['orange', 'yellow', 'green'];
let colorfulGems = gems.concat(gemColors);
console.log('Combined gems and colors array:', colorfulGems);
